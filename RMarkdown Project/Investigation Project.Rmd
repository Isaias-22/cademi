...
Analizamos detalladamente el trabajo realizado por Amy Edmonson, durate un periodo de 5 meses. Mientras se realizaba este proceso, se efectuo tambien la recopilacion de datos a travez de las encuestas realizadas a los estudiantes.

Lo primero fue evaluar las hipotesis a comprobar dentro del proyecto (H1, H2 y H3). Para ello, se diseñaron ciertas preguntas con ayuda de los docentes, acorde a las escalas ya antes previstas. De esta forma, fueron siendo entregadas a los estudiantes a lo largo del tiempo estimado (t). En total se realizaron 3 periodos de encuestas que contenian este tipo de preguntas-(nose si queda claro)-.
